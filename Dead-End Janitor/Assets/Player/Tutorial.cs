...
public class Tutorial : MonoBehaviour
{
    ...
    Color ZombieTextColor = new Color(0,100/255,0,85/255);
    Color ZombieBarColor = new Color(0,0,0,85/255);
    ...
    public void DoGameStartText(){
        ...
        SH.AcceptNew("You", "...",20,ZombieBarColor,ZombieTextColor,1,1);
        SH.AcceptNew("You", "This Place is Absolutely FILTHY.",20,ZombieBarColor,ZombieTextColor,2,5,0.5f);
        SH.AcceptNew("You", "IT MUST BE CLEANSED!",20,ZombieBarColor,ZombieTextColor,2,3,0.5f);
        SH.AcceptNew("You", "...Who's that?",20,ZombieBarColor,ZombieTextColor,1,3,0.25f);
        SH.PlayNext();
    }
    void Start()
    {
